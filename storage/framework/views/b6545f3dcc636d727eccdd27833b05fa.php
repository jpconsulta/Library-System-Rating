<div class="max-w-7xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->check() && auth()->user()->is_admin): ?>
        <a href="<?php echo e(route('services.create')); ?>" wire:navigate
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="relative group bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition border border-gray-100 dark:border-gray-700 flex flex-col">
            ...
            <a href="<?php echo e(route('services.show', $service->id)); ?>" wire:navigate class="flex-grow p-6 block">
                <div class="flex justify-between items-start mb-2">
                    ...
                    <div class="flex items-center gap-1 bg-yellow-50 dark:bg-yellow-900/30 px-2 py-1 rounded text-yellow-700 dark:text-yellow-400 text-xs border border-yellow-100 dark:border-yellow-800/50 shrink-0">
                        <span class="font-bold">★ <?php echo e(number_format($service->avg_rating, 1)); ?></span>
                        <span class="text-yellow-600/70 dark:text-yellow-500/70 ml-0.5">
                            (<?php echo e($service->ratings_count); ?>)
                        </span>
                    </div>
                </div>
            ...
            <div class="px-6 pb-4 flex justify-end">
                <div class="flex gap-3 relative z-10">
                    ...
                    <a href="<?php echo e(route('services.edit', $service->id)); ?>" wire:navigate
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH /Users/jaimeconsulta/Downloads/feedbacksystem-main/resources/views/livewire/library-services.blade.php ENDPATH**/ ?>